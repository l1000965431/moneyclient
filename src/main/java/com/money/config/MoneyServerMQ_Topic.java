...
/*    public static final String MONEYSERVERMQ_ORDERINSERT_TOPIC = "MoneyServer_Order_Insert";
    ...
    public static final String MONEYSERVERMQ_ACTIVITYBUY_TOPIC = "MoneyServer_Buy_Listener";
    public static final String MONEYSERVERMQ_ACTIVITYBUY_TAG = "MoneyServer_Buy_Listener";

    public static final String MONEYSERVERMQ_LOTTERY_TOPIC = "MoneyServer_Lottery_Listener";
    public static final String MONEYSERVERMQ_LOTTERY_TAG = "MoneyServer_Lottery_Listener";
    ...
    public static final String MONEYSERVERMQ_LOTTERVACTIVITYPREFERENTIAL_TOPIC = "MoneyServer_LotteryActivityPreferentialListener_Listener";
    public static final String MONEYSERVERMQ_LOTTERVACTIVITYPREFERENTIAL_TAG = "MoneyServer_LotteryActivityPreferentialListener_Listener";

    public static final String MONEYSERVERMQ_JOINACTIVITYPREFERENTIAL_TOPIC = "MoneyServer_JoinActivityPreferentialListener_Listener";
    public static final String MONEYSERVERMQ_JOINACTIVITYPREFERENTIAL_TAG = "MoneyServer_JoinActivityPreferentialListener_Listener";
    ...
    public static final String MONEYSERVERMQ_LOTTERVACTIVITYPREFERENTIAL_TOPIC = "MoneyServer_LotteryActivityPreferentialListener_Listener_liveQ";
    public static final String MONEYSERVERMQ_LOTTERVACTIVITYPREFERENTIAL_TAG = "MoneyServer_LotteryActivityPreferentialListener_Listener_liveQ";

    public static final String MONEYSERVERMQ_JOINACTIVITYPREFERENTIAL_TOPIC = "MoneyServer_JoinActivityPreferentialListener_Listener_liveQ";
    public static final String MONEYSERVERMQ_JOINACTIVITYPREFERENTIAL_TAG = "MoneyServer_JoinActivityPreferentialListener_Listener_liveQ";

    public static final String MONEYSERVERMQ_UMENGPUSHCUSTOMMESSAGE_TOPIC = "MoneyServer_PushCustomMessageListener_Listener_liveQ";
    public static final String MONEYSERVERMQ_UMENGPUSHCUSTOMMESSAGE_TAG = "MoneyServer_PushCustomMessageListener_Listener_liveQ";

    public static final String MONEYSERVERMQ_INSTALLMENTTEST_TOPIC = "MoneyServer_InstallmentTest_Listener_liveQ";
    public static final String MONEYSERVERMQ_INSTALLMENTTEST_TAG = "MoneyServer_InstallmentTest_Listener_liveQ";
