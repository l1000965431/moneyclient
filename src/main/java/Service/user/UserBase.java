 ...
 */
    ...
    public boolean changePassword(String userName,String newPassWord) {
        UserModel userModel = (UserModel)baseDao.load(UserModel.class,userName);
        userModel.setPassword(newPassWord);
        baseDao.save(userModel);
    ...
    {
        writeInfo(userName,map);
        UserBorrowModel userBorrowModel=(UserBorrowModel)baseDao.load(UserBorrowModel.class,userName);
