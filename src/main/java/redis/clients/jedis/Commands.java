...
public interface Commands {
   ...
   */ void scan(int cursor, final ScanParams params);
   ...
   * And will be removed on next major release
   * @see https://github.com/xetorthio/jedis/issues/531 
   */ void hscan(final String key, int cursor, final ScanParams params);
   ...
   * And will be removed on next major release
   * @see https://github.com/xetorthio/jedis/issues/531 
   */ void sscan(final String key, int cursor, final ScanParams params);
   ...
   * And will be removed on next major release
   * @see https://github.com/xetorthio/jedis/issues/531 
   */ void zscan(final String key, int cursor, final ScanParams params);
